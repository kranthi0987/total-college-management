...
public class StudentExternalMarksSubjectDetailsResponse implements Parcelable {

    public static final Parcelable.Creator<StudentExternalMarksSubjectDetailsResponse> CREATOR = new Parcelable.Creator<StudentExternalMarksSubjectDetailsResponse>() {
        @Override
        public StudentExternalMarksSubjectDetailsResponse createFromParcel(Parcel source) {
            return new StudentExternalMarksSubjectDetailsResponse(source);
        }

        @Override
        public StudentExternalMarksSubjectDetailsResponse[] newArray(int size) {
            return new StudentExternalMarksSubjectDetailsResponse[size];
        }
    };
    ...
    public StudentExternalMarksSubjectDetailsResponse() {
    }

    protected StudentExternalMarksSubjectDetailsResponse(Parcel in) {
