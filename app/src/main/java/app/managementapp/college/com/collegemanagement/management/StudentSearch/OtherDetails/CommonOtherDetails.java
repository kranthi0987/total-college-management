...
public class CommonOtherDetails extends AppCompatActivity {

    private static final String DEBUG_TAG = "CommonOtherDetails";
    public AbstractOtherDetails commonClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_other_details);
...
//            datalist.getID(i);
    ...
    public void fillUpTheScreen(List<String> keys, List<String> values) {
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.otherDetailsItemsCont);
        linearLayout.removeAllViews();
        LayoutInflater inflater = LayoutInflater.from(this);
        try {
            if (keys.size() == values.size()) {
                for (int i = 0; i < keys.size(); i++) {
                    View view = inflater.inflate(R.layout.row_other_details_item, linearLayout, false);
                    ((TextView) view.findViewById(R.id.otherDetailKey)).setText(keys.get(i));
                    ((TextView) view.findViewById(R.id.otherDetailValue)).setText(values.get(i));
        ...
        public void useLoginToken(String result) {
            try {
                ...
                if (resultJSON.getInt("ServiceResult") == 0) {
                    ...
                    i = new Intent(CommonOtherDetails.this, LoginActivity.class);
