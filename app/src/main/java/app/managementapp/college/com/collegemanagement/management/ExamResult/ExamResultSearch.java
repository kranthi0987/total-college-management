...
public class ExamResultSearch extends AppCompatActivity {
    ...
    View.OnClickListener onSearchclickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Log.d(DEBUG_TAG, "onClick: onFilterbackTimeTableclickListener");
            Intent i = new Intent(ExamResultSearch.this, ExamResultSearchList.class);
            startActivity(i);
            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseAdapter = new app.managementapp.college.com.collegemanagement.management.ExamResult.CourseDropDownAdapter(this, courseList);
        courseAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        courseSpinner.setAdapter(courseAdapter);
        TextView header = (TextView) findViewById(R.id.title);
        header.setText("Exam Result");
        ...
        defaultcourse.setDrpID("0");
        defaultcourse.setDrpName("Pick Course");

        defaultsemester.setDrpID("0");
        defaultsemester.setDrpName("Pick Course");
                                            ...
                                            public void onResponse(Call<RegularLoginResponse> call, Response<RegularLoginResponse> response) {
                                                ...
                                                branchListResponseCall.enqueue(new Callback<BranchListResponse>() {
                                                    ...
                                                    public void onResponse(Call<BranchListResponse> call, Response<BranchListResponse> response) {
                                                        ...
                                                        branchAdapter.branches.add(0, defaultbranch);
