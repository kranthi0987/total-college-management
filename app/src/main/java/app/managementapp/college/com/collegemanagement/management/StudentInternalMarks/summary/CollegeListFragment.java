    ...
    public void fetchData() {
        ...
        loginCall.enqueue(new Callback<RegularLoginResponse>() {
            ...
            public void onResponse(Call<RegularLoginResponse> call, Response<RegularLoginResponse> response) {
                final Call<StudentInternalMarksSummaryResponse> collegeListResponseCall = collegeManagementApiService.getStudentInternalMarkSummary(response.body().getToken(), "0", "1", "1", "171");
                collegeListResponseCall.enqueue(new Callback<StudentInternalMarksSummaryResponse>() {
                    @Override
                    public void onResponse(Call<StudentInternalMarksSummaryResponse> call, Response<StudentInternalMarksSummaryResponse> response) {
                    ...
                    @Override
                    public void onFailure(Call<StudentInternalMarksSummaryResponse> call, Throwable t) {
