...
public interface CollegeManagementApiService {
    ...
    Call<BranchListResponse> getBranchOrCycle(@Header("Token") String token, @Query("CourseID") Integer courseid, @Query("sem") Integer sem);
    ...
    Call<SemesterListResponse> getSemester(@Header("Token") String token, @Query("CourseID") Integer courseid);
