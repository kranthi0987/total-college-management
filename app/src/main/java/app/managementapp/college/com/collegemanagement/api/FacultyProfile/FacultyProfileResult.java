...
public class FacultyProfileResult implements Parcelable {
    ...
    public static final Creator<FacultyProfileResult> CREATOR = new Creator<FacultyProfileResult>() {
        @Override
        public FacultyProfileResult createFromParcel(Parcel in) {
            return new FacultyProfileResult(in);
        }

        @Override
        public FacultyProfileResult[] newArray(int size) {
            return new FacultyProfileResult[size];
        }
    };
    ...
    protected FacultyProfileResult(Parcel in) {
